...
export default function SignUpPage() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Create your account to identify aircraft"
    ...
    >
      <form className="space-y-3" onSubmit={handleSubmit}>
        ...
        <button type="submit" disabled={isLoading} className="mt-4 h-9 w-full rounded-[3px] bg-[#4a3fb8] text-[11px] font-medium text-white transition hover:bg-[#5649c7] disabled:opacity-80 disabled:cursor-not-allowed flex items-center justify-center gap-2">
